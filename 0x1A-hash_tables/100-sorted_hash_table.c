...
/**
 * shash_table_create - Used to create sorted hash table.
 * @size: number of array slots needed to make the hash table.
 *
 * Return: pointer to the hash table that will be created, or NULL if malloc fails.
 */
...
/**
 * set_spair - mallocs a key & value pair to the hash table to be sorted.
 * @key: the key, a string that must never be empty.
 * @value: the value associated with the key, can be an string that is empty.
 *
