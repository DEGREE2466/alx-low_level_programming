...
/**
 * node_at_index - returning the node at an index in the list
 *
 * @list: linked list
 * @index: index at which to get the node
 *
...
/**
 * linear_skip - searches for a node in a sorted skiplist of integers
 * using the jump search algorithm.
 *
 * @list: linked list of integers
 * @value: the value to search for
 *
 * Return: a pointer to node where @value is located or NULL if not found
 */
